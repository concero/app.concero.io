...
export const EntityListModal: FC<EntityListModalProps> = ({ title, data, columns, show, setShow, onSelect }) => {
  ...
  return (
    <Modal title={title} show={show} setShow={setShow} size={{ width: 400, height: 400 }}>
      <TextInput iconName="Search" value="" placeholder="Search chain" onChangeText={(val) => filter(val)} />
